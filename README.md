...
- **Intent & Query Classification**: Deterministic classifier routing queries to `RAG` (paper questions), `WEB` (current / external questions), or `HYBRID` (comparative questions).
